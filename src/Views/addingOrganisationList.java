...
public class addingOrganisationList extends JFrame implements Serializable{
     ...
     */
    public addingOrganisationList(OrganisationData orgData) {
        this.orgData = orgData;
//        this.assetData = assetData;
//        array = new String[assetData.getSize()];
    ...
    private JPanel makeUserFieldPanel() {
        ...
        hGroup.addGroup(layout.createParallelGroup().addComponent(orgLabel).addComponent(orgCredits));
        hGroup.addGroup(layout.createParallelGroup().addComponent(orgField).addComponent(orgCreditsField));
    ...
    public static void main(String[] args) {
        new addingOrganisationList(new OrganisationData(new NetworkDataSource()));
    }
