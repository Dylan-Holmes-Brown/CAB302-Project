...
public class NetworkDataSource implements AssetTypeDataSource, OrganisationDataSource, UserDataSource, CurrentDataSource, TradeHistoryDataSource {
    ...
    public AssetType getAsset(String assetName) {
        try {
            // Tell main.server - expect asset name, and send the details
    ...
    public void addOrg(Organisation org) {
        ...
        try {
            // Tell the main.server to expect a organisation's details
    ...
    public Organisation getOrg(Integer id) {
        try {
            // Tell main.server to expect a organisations name, and send the details
            outputStream.writeObject(Commands.GET_ORG);
            outputStream.writeObject(id);
            outputStream.flush();

            // Read the organisation's details from the main.server
    ...
    public void addUser(User user) {
        ...
        try {
            // Tell the main.server to expect a user's details
    ...
    public User getUser(String username) {
        try {
            // Tell the main.server to expect the user's username, and send the details
    ...
    public int getUserSize() {
        try {
            ...
            // Read the user details from the main.server
            return inputStream.readInt();
        } catch (IOException | ClassCastException e) {
            e.printStackTrace();
            return 0;
    ...
    public Trade getCurrentTrade(Integer id) {
        try {
            // Tell the main.server to expect the current trades id, and send the details
